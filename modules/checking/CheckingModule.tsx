...
export const CheckingModule = () => {
    ...
    return(
        <>
            ...
            />
            <div
                className="width-full max-w-[1200px] h-auto m-auto p-4 flex flex-col justify-center z-20"    
            >
                <h1
                    className="text-[#1678F2] text-5xl text-bold mb-4 mt-16"
                >Breast Cancer <span className="text-black text-6xl">Checking</span></h1>

                <div className="z-20 w-full flex items-center justify-evenly flex-wrap">
                    ...
                    <CheckingCard title={"Self Breast Checking"} description={"A clinical breast exam is a physical examination of your breasts that is performed by a health care provider. It is often done during your yearly medical check-up. The provider will visually inspect your breasts for any changes in size, shape, or color. They will also feel your breasts for any lumps or other abnormalities"} alt="self-breast-checking" image={"/images/stethoscope.png"} link={"#"} />
                    <CheckingCard title={"Self Breast Checking"} description={"A mammogram is an X-ray of the breast. It is used to detect breast cancer early, when it is most treatable. Mammograms are recommended for women starting at age 45, but may be started earlier for women at higher risk for breast cancer. The mammogram procedure is painless, but it can be uncomfortable for some women. There is a small amount of radiation exposure associated with mammograms, but the benefits of early detection of breast cancer outweigh the risks"} alt="mammogram" image={"/images/research.png"} link={"#"} />
                    <CheckingCard title={"Self Breast Checking"} description={"A biopsy is a medical procedure in which a doctor removes a small sample of tissue from the body for examination under a microscope. Biopsies are used to diagnose a variety of conditions, including cancer, infections, and autoimmune diseases"} alt="biospy" image={"/images/biopsy.png"} link={"#"} />
                    <CheckingCard title={"Self Breast Checking"} description={"There are many different treatments for breast cancer, and the best treatment for you will depend on the type of breast cancer you have, how far it has spread, and your overall health. Some common treatments for breast cancer include surgery, chemotherapy, radiation therapy, hormone therapy, and targeted therapy"} alt="treatments" image={"/images/radiation.png"} link={"#"} />
                </div>
            </div>
        </>
    )
